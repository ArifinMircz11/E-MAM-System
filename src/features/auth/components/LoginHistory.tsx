...
import { ShieldCheckIcon, ClockIcon, Loader2, CommandLineIcon } from '@/shared/Icons';
          ...
          <div className="space-y-3">
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl p-4 mb-4 flex gap-3 items-start">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                Berikut adalah daftar aktivitas login terakhir ke akun Anda. Jika Anda melihat
                perangkat yang tidak dikenal, segera ubah kata sandi Anda.
              </p>
            </div>
            ...
            {history.map((entry) => (
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center ${entry.status === 'Success' ? 'bg-green-50 dark:bg-green-900/20 text-green-600' : 'bg-red-50 dark:bg-red-900/20 text-red-600'}`}
                  >
