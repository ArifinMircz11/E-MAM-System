/**
 * Utility untuk konversi dan formatting zona waktu Asia/Makassar (WITA - UTC+8)
 * Menjamin konsistensi waktu antara browser klien (lokal) dan container server (UTC).
 */

/**
 * Mendapatkan objek Date dalam waktu Makassar (UTC+8)
 */
export function getMakassarDate(date: Date = new Date()): Date {
  try {
    ...
    // Fallback jika Asia/Makassar tidak disupport (sangat jarang)
